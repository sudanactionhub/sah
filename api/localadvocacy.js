 ...
 * 
 * Deployment: This file should be placed in /api/localadvocacy.js for Vercel deployment
...
async function storeSubmission(sanitizedData) {
  ...
  try {
    const { data, error } = await supabase
      .from('localadvocacy_submissions')
      .insert([
        {
          ...
          involvementlevel: JSON.stringify(sanitizedData.involvementlevel || []),
