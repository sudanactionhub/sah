  ...
  return (
    <footer className="bg-black text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-[25%_15%_20%_20%_20%] gap-6">
          <div className="flex items-top space-x-2  mb-2 mr-2 ">

            <p className="text-5 text-white font-semibold">
          ...
          <div>
            <a aria-label="Sudan Action Hub" href="https://app.candid.org/profile/16526276/sudan-action-hub-41-2854524/?pkId=aca7f0ef-0190-4695-a142-819ebb8436b0" 
          ...
          <div>
            <span className="text-white font-semibold mb-2 block">Get Involved</span>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            ...
            <div className="flex float-bottom space-x-2 mt-4 pt-2 pb-2 ">
        ...
        <div >
          <div className="flex justify-center border-t border-gray-800 mt-2 block" >
          <img src = "https://krziguirzqciqqjbstrx.supabase.co/storage/v1/object/sign/sah_logo/SAHLogoTransparent_White.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9mODU5YWMwYy1lOGI0LTQ5Y2MtODExMC0yMjUwNjM3ZDU1OTQiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJzYWhfbG9nby9TQUhMb2dvVHJhbnNwYXJlbnRfV2hpdGUucG5nIiwiaWF0IjoxNzcyMTU5MDA2LCJleHAiOjIwODc1MTkwMDZ9.FI6s3PSsUB6Tdx7H1v0p4mb1XUg0Gufb5oI0_apf6E0"
                 alt="Sudan Action Hub Logo" className="float-center h-40" />
           </div>
           <div className='flex justify-center justify-center text-sm block"'>
          <p>&copy; 2026 Sudan Action Hub. All rights reserved. * </p>
          <a href="/privacypolicy" className="hover:text-green-400 text-right transition-colors underline" >
                Privacy Policy</a>
                </div>
        </div>
      </div>
